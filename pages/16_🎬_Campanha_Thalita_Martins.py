"""
Página institucional pública da campanha (parceira Thalita Martins).
Renderiza static/pages/campanha_thalita_martins.html dentro de um iframe
...
HTML_PATH = PROJECT_ROOT / "static" / "pages" / "campanha_thalita_martins.html"
